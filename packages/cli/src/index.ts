...
program
  ...
  .action(async (opts) => {
    try { await init(opts); } catch (e: any) {
...
program
  ...
  .action(async (slug) => {
    try { await newCommand(slug); } catch (e: any) {
...
program
  ...
  .action(async (specId, opts) => {
    try { await runCommand(specId, opts); } catch (e: any) {
...
program
  ...
  .action(async (specId) => {
    try { await runCommand(specId, { step: true }); } catch (e: any) {
...
program
  ...
  .action(async (specId) => {
    try { await statusCommand(specId); } catch (e: any) {
...
program
  ...
  .action(async (specId, answer) => {
    try { await answerCommand(specId, answer); } catch (e: any) {
...
program
  ...
  .action(async (specId, reason) => {
    try { await abortCommand(specId, reason); } catch (e: any) {
...
program
  ...
  .action(async () => {
    try { await doctorCommand(); } catch (e: any) {
...
program
  ...
  .action(async (opts) => {
    try { await adoptCommand(opts); } catch (e: any) {
