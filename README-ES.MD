...
**El trabajo activo de este repo** no cambia: las definiciones devcontainer de DevPod/Codespaces que arrancan el plano de ejecución remoto del rig (guías abajo).
